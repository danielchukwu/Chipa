...
function LandingPage() {
  ...
  return (
    <main className="min-h-screen bg-[#FCFAF7] text-[#111111] overflow-x-hidden">
      {/* ========================================================================= */}
      {/* 1. HERO SECTION                                                          */}
      {/* ========================================================================= */}
      <section className="page-container pt-8 sm:pt-12 lg:pt-16 pb-16 sm:pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-12 lg:gap-8 min-h-[580px]">
          ...
          <div className="lg:col-span-6 xl:col-span-7 flex flex-col justify-center rise-in">
            ...
            <div className="mt-8 sm:mt-10">
              <button
                ...
                className="inline-flex items-center justify-center bg-[#18181B] hover:bg-black text-white text-base sm:text-lg font-semibold px-8 sm:px-10 py-4 rounded-full transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] shadow-sm hover:shadow-md cursor-pointer"
              >
                Join the waitlist
              </button>
            </div>
            ...
            <div className="lg:col-span-6 xl:col-span-7 flex flex-col justify-center z-10">
              ...
              <div className="mt-8 sm:mt-10">
                <button
                  type="button"
                  onClick={openWaitlist}
                  className="inline-flex items-center justify-center bg-white hover:bg-black text-[#111111] hover:text-white border border-[#111111] text-sm sm:text-base font-semibold px-7 sm:px-8 py-3.5 rounded-full transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] shadow-sm cursor-pointer"
                >
                  Join the waitlist
                </button>
              </div>
