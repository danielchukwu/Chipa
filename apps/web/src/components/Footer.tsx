...
import DownloadOnAppstoreIcon from "@repo/ui/icons/landing-page/download-on-appstore-icon.tsx";
import GetItOnPlayStoreIcon from "@repo/ui/icons/landing-page/get-it-on-playstore-icon.tsx";
        ...
        <div className="bg-[#FDBE4E] rounded-[2.5rem] sm:rounded-[3.25rem] p-8 sm:p-14 md:p-16 relative overflow-hidden shadow-2xl border border-[#FDB837]">
          ...
          <div className="text-center max-w-2xl mx-auto">
            ...
            {/* <div className="mt-8 sm:mt-10 flex flex-wrap items-center justify-center gap-4">
              <DownloadOnAppstoreIcon className="h-10 w-fit" />
              <GetItOnPlayStoreIcon className="h-10 w-fit" />
            </div> */}
          </div>
        </div>
      </div>
